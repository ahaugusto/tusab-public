...
from brainiac_engine.storage import INDEX_DIR
from brainiac_engine.agent.config import carregar_config
...
def _montar_prompt(pergunta: str, contexto: list, meta_canal: dict = None, historico: list = None, busca_ampla: bool = False) -> str:
    ...
    if busca_ampla:
        ...
        instrucoes = (
            f"Você é o Brain'IAC, um assistente que responde EXCLUSIVAMENTE com base nas fontes abaixo.\n\n"
