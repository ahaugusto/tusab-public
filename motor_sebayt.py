...
# Shim de compatibilidade — todo o código migrou para sebayt_engine/motor/.
# Este arquivo permanece na raiz porque:
#   (a) electron/package.json o lista em extraResources.filter;
#   (b) api_brainiac.py usa `motor_sebayt.*` por todo o código.

from sebayt_engine.motor.drive import (                        # noqa: F401
...
from sebayt_engine.motor.extraction import (                   # noqa: F401
