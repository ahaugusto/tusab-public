...
# Shim de compatibilidade — todo o código migrou para sebayt_engine/agent/.
...
#   (c) api_brainiac.py usa `agent_sebayt.*` por todo o código.

from sebayt_engine.agent.config import carregar_config, salvar_config           # noqa: F401
from sebayt_engine.agent.index import (                                          # noqa: F401
...
from sebayt_engine.agent.chat import (                                           # noqa: F401
    chat, chat_stream, _recuperar_contexto,
)
from sebayt_engine.storage import (                                              # noqa: F401
