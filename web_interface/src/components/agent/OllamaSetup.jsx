      ...
      <div className={`rounded-xl p-3.5 border flex gap-2.5 ${darkMode ? 'bg-white/4 border-white/10' : 'bg-slate-50 border-slate-200'}`}>
        ...
        <div className="space-y-1.5 min-w-0">
          ...
          <p className={`text-[10px] leading-relaxed ${darkMode ? 'text-slate-500' : 'text-slate-500'}`}>
            O <strong className={darkMode ? 'text-slate-400' : 'text-slate-600'}>Ollama</strong> é um serviço que roda modelos de IA diretamente no seu computador — sem internet, sem custo por uso e sem enviar dados para servidores externos. É a forma recomendada de usar o Tusab.
          </p>
