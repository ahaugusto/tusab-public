...
export default function AgentTab({
  ...
  return (
    <div id="panel-agente" role="tabpanel" aria-labelledby="tab-agente"
      ...
      {/* ── Sub-tab bar (mesmo padrão da aba de Extração) ── */}
      ...
      {/* Conteúdo scrollável */}
      <div className="flex-1 overflow-y-auto px-4 lg:px-8 pt-5 pb-6 space-y-4 custom-scrollbar">
