...
> **Memória institucional:** consulte `agents/_historia.md` antes de qualquer análise — em especial as invariantes 12 (createPortal com document.body) e os bugs de z-index/portal/aria-hidden das v1.0.12–17. **A documentação oficial do sistema é `Documentação do Produto/Design System — Tusab.md`** — levantada por medição real do código (jul/2026). Divergência entre doc e código é bug: quem estiver errado, corrige.
>
